...
<img src="https://skillicons.dev/icons?i=vite,tailwind,html,css,js,ts,nodejs,react,nextjs,python,php,mysql,linux,github,vscode,docker,firebase,sql,ia,figma&perline=8" width="90%" />
